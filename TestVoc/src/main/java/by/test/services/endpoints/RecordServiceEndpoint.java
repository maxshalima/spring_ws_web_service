...
public class RecordServiceEndpoint {
    ...
    SearchRecordsResponse searchRecordsLessThan(@RequestPayload SearchRecordsRequest request) throws Exception {
        SearchRecordsResponse response = new SearchRecordsResponse();
        List<VocabloryRecord> vocabloryRecords = recordService_i.searchRecordsLessThan(request.getVocablory(),
                request.getContent());
    ...
    public @ResponsePayload
    GetAllVocabloriesResponse getAllVocablories(@RequestPayload GetAllVocabloriesRequest request) throws Exception {
    ...
    public @ResponsePayload
    GetNumberOfRecordsResponse getNumberOfRecord(@RequestPayload GetNumberOfRecordsRequest request) throws Exception {
    ...
    public @ResponsePayload
    AddRecordToVocabloryResponse addRecordToVoc(@RequestPayload AddRecordToVocabloryRequest request) throws Exception {
        AddRecordToVocabloryResponse response = new AddRecordToVocabloryResponse();
        boolean isSuccessed = recordService_i.addRecordToVoc(request.getVocabloryName(), request.getContent());
